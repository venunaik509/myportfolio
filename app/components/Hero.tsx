    ...
    <div className="overflow-hidden">
      ...
      >
        ...
        <p className="md:text-[1.2rem] lg:text-[1.3rem] bg-clip-text text-transparent bg-gradient-to-b from-neutral-200 to-neutral-500 py-3 w-[90%] text-center">
          ...
          here in Tirupati, India📍
        </p>
        <div className="flex gap-4 mt-4">
          <Link href="https://github.com/venunaik509" className="text-xl md:text-2xl cursor-pointer" target="_blank">
            <FiGithub />
          </Link>
          <Link href="https://x.com/NaikVenues" className="text-xl md:text-2xl cursor-pointer" target="_blank">
          <FaXTwitter />
          </Link>
        </div>
      </motion.div>
