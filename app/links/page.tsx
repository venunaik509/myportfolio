...
const links = [
  {
    name: "Github",
    username: "venunaik509",
    link: "https://github.com/venunaik509",
    icon: <FaGithub className="w-5 h-5" />,
  },
  {
    name: "Twitter",
    username: "venu-x",
    link: "https://x.com/NaikVenues",
  ...
  },
  {
    name: "LinkedIn",
    username: "venu-naik",
    link: "https://www.linkedin.com/in/venunaik123/",
    icon: <FaLinkedin className="w-5 h-5" />,
  },
  {
    name: "Leetcode",
    username: "venu_12",
    link: "https://leetcode.com/u/venu12/",
    icon: <TbBrandLeetcode className="w-5 h-5" />,
  },
  {
    name: "Instagram",
    username: "mr_vinnu",
    link: "https://www.instagram.com/mr_vinnu.20/",
